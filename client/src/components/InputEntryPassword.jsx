...
function InputEntryPassword(props) {
    return <div className="text-center">   
        <label className="text-xl text-black" htmlFor={props.name}>{props.text}</label><br />
        <input onChange={props.changeFunction} type="password" className="px-3 py-1 rounded-lg mb-7 mt-3 w-64 h-10 text-center bg-[#eeeeee] text-black"
