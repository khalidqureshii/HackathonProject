      ...
      {isLoading ? (
        ...
        <div className="min-h-screen flex flex-col justify-center items-center bg-gray-100 mt-5">
          <div className="bg-white rounded-xl shadow-lg p-10 w-full max-w-lg">
            <h1 className="mb-6 text-5xl text-center text-black">Complete Your Registration</h1>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="mt-8 flex flex-col items-center">
                <label className="block text-black text-[1.25rem] leading-[1.75rem] mb-2">
                  User Type
                </label>
                <div className="flex items-center mt-2">
                  <label className="text-black text-[1.25rem] leading-[1.75rem] mr-6">
                    <input
                      type="radio"
                      name="userType"
                      value="Alumni"
                  ...
                  <label className="text-black text-[1.25rem] leading-[1.75rem]">
                    <input
                      type="radio"
                      name="userType"
                      value="Student"
